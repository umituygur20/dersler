...
public enum Cities {
    /**değişme ihtimali olmayan dataları depolamak için kullanırız.
     *ün , ay , yıl isimleri misal
     *eğişmez bazı datalara ihtiyaç duyarsanız bunu enum içinde depolayabilirsin.
     *Hocam neler değişmez .Tr'deki il isimleri --> değişmez */
    //standAlone (Bağımsız- Tek başına ayakta durabilir şekilde yapmalıyız.)
